...
export async function createEvent({ name, slug, description, location } = {}) {
  const q = `
    INSERT INTO events
      (name, slug, description, location)
    VALUES
      ($1, $2, $3, $4)
    RETURNING id, name, slug, description, location;
  `;
  const values = [name, slug, description, location];
